...
The success of AlexNet started a small revolution. Convolutional neural network became the facade of Deep Learning, which became the new name for "large neural networks that can now solve useful tasks".
