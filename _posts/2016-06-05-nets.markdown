...
For a more in-depth analysis and comparison of all the networks reported here, please see our [recent article](https://arxiv.org/abs/1605.07678). One representative figure from this article is here:
...
# LeNet5
It is the year 1994, and this is one of the very first convolutional neural networks, and what propelled the field of Deep Learning. This pioneering work by Yann LeCun was named [LeNet5](http://yann.lecun.com/exdb/publis/pdf/lecun-01a.pdf) after many previous successful iterations since the year 1988! 
...
A Torch7 implementation of this network is available [here](https://gist.github.com/culurciello/554c8e56d3bbaf7c66bf66c6089dc221)
An implementation in Keras/TF is availble [here](https://keras.io/applications/#xception).


It is interesting to note that the recent Xception architecture was also inspired by [our work on separable convolutional filters](https://arxiv.org/abs/1412.5474).
