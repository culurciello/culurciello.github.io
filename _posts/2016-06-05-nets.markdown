...
- convolutional neural network use sequence of 3 layers: convolution, pooling, non-linearity --> This may be the key feateure of Deep Learning for images since this paper!
...
[ResNet](https://arxiv.org/abs/1512.03385) have a simple ideas: feed the output of two successive convolutional layer AND the inout again to the next layer! Bypass after 2 layers is key here, as bypassing a single layer did not give much improvements. By 2 layers can be thought as a small classifier, or a Network-In-Network!
