...
# Inception V3 (and V2)
Christian and his team are very efficient researchers. In February 2015 [Batch-normalized Inception](http://arxiv.org/abs/1502.03167) was introduced as Inception V2. Batch-normalization computes the mean and standard-deviation of all feature maps at the output of a layer, and normalizes their responses with these values.
