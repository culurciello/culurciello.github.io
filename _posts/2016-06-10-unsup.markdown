...
More on generative models is also [here](https://openai.com/blog/generative-models/) and [here](https://code.facebook.com/posts/1587249151575490/a-path-to-unsupervised-learning-through-adversarial-networks/).
